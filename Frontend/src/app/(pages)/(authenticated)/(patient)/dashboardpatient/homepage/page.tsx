                ...
                <div className="relative z-10 h-full flex items-center justify-start pl-10">
                    <div className="text-left max-w-xl">
                        ...
                        <div className="mt-4">
                            ...
                            <div className="flex">
                                <input style={{ backgroundImage: "url('/search.svg')", backgroundRepeat: "no-repeat", backgroundPosition: "10px 50%" }}
                                    type="text"
                    ...
                    <div className="grid grid-cols-2 gap-4 mx-auto">
                        ...
                        <div className="border-2 rounded p-4 flex justify-between items-center" style={{ width: "16rem" }}>
                            <div>
                                ...
                                <p className="text-gray-700">Number of Doctors</p>
                            </div>
                            <div className="bg-gray-200 p-3 rounded-md">
                                <img src="/doctors-hover.svg" className="w-8 h-8" alt="Patient Icon" />
                            </div>
                        </div>
